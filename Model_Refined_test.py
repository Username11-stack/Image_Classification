...
def main():
    ...
    print(f"Heres the train dataloader:\n{train_dataloader}\nAnd the test dataloader:\n{test_dataloader}")
    ...
    start_time = timer()
    model_1_results = Config.train(model=model_1,
    ...
    Config.plot_loss_curves(model_1_results)

    Config.pred_and_plot_image(model=model_1,
                        image_path="C:/Users/anchi/GitHub/Repos/Image_Classification/Data_Refined/Test/ADONIS/Image_280.jpg",
                        class_names=train_data.classes,
